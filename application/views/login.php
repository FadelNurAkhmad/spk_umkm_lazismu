...
<html lang="en">
    <head>
        ...
        <title>Sistem Pendukung Keputusan Penentuan Bantuan UMKM Lazismu DIY</title>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <img src="<?= base_url('assets/')?>img/lazismu-logo.png" width="80px">
                <a class="navbar-brand text-dark" style="font-weight: 900;" href="<?= base_url('')?>"> Sistem Pendukung Keputusan Penentuan Bantuan UMKM Lazismu DIY</a>
                  <!-- <i class="fa fa-database mr-2 rotate-n-15"></i> -->
            </div>
        </nav>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">Sistem Pendukung Keputusan Penentuan Bantuan UMKM Lazismu DIY</h4>
                            <p class="pt-4">
